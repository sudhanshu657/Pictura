   ...
   const onClickHandler = ()=> {
    ...
    return (
        <motion.div className='flex flex-col justify-center items-center text-center my-20'
            ...
            >
                Transform words into <span className='text-blue-600' >visuals,</span> fast.</motion.h1>

            <motion.p className='text-center max-w-xl mx-auto mt-5'
                initial={{opacity:0, y: 20}} animate={{ opacity:1, y:0 }}  transition={{delay:0.6, duration:0.8}}
            >
                Generate AI images from text instantly with imagify — the best text-to-image generator for creators, brands, and storytellers. No design skills required.
            </motion.p>
